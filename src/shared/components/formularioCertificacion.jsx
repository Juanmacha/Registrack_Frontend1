...
const FormularioCertificacion = () => {
  const [paso, setPaso] = useState(2); // Suponiendo que estás mostrando el paso 2 directamente
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <NavBarLanding />
      <div className="max-w-5xl mx-auto pt-[30px] p-6">
          {/* Paso 2: Datos de la marca y Clase NIZA */}
          {paso === 2 && (
